...
;;; SRH
;;; SRH Disabled these two #if sections that enforce jump table within 256 byte block.
;;; SRH     Because the calculations require usage of $ variable, this routine must be
...
;;; SRH     ; into the next 256 byte block.
...
;;; SRH #if (JUMPTABLE_BEGIN & 0xFF) > ($ & 0xFF)
;;; SRH     error "Jump table is not aligned to fit within a single 256 byte address range."
;;; SRH #endif
; *****************************************************************************
